...
// โหมดบอสรวมพลัง: เลือดบอส = ผู้เล่นตอนเริ่ม × จำนวนข้อ × อัตรานี้
// ตอบถูก 1 ดาเมจ ตอบไว 2 ดาเมจ ถ้าทุกคนตอบถูกทุกข้อแม้ช้าก็ชนะพอดีมีเผื่อ
export const BOSS_HP_RATIO = 0.8;
// ข้อไหนตอบถูกไม่ถึงครึ่งห้อง บอสสวนกลับ ทีมเสียหัวใจหนึ่งดวง หมดเมื่อไหร่แพ้
