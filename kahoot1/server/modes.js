...
export const MODES = {
    ...
    boss: {
        // ทั้งห้องร่วมมือกันแทนการแข่ง: ทุกคำตอบที่ถูกลดเลือดบอสตัวเดียวกัน ชนะหรือแพ้พร้อมกันทั้งห้อง
        // คะแนนรายคนยังคิดแบบคลาสสิก แท่นรับรางวัลตอนจบจึงยังมีอยู่
        label: { th: "บอสรวมพลัง", en: "Boss Raid" },
        desc: {
            th: "ทั้งห้องช่วยกันตีบอส ตอบถูกลดเลือดบอส ตอบถูกไม่ถึงครึ่งห้องบอสสวนกลับ",
            en: "The whole room fights one boss — correct answers deal damage, and it hits back when fewer than half get it right"
        },
        color: "#b91c1c",
        icon: "🐉",
        boss: true
    ...
    tower: {
        // ตอบถูกได้บล็อกต่อตึกของตัวเอง ความสูงตึก = คะแนนสะสมพอดี คะแนนคิดแบบคลาสสิกทุกอย่าง แท่นรับรางวัลจึงตรงกับตึก
        // ธงนี้แค่ให้เซิร์ฟเวอร์แนบคะแนนรายข้อ (gains) ไปกับรายชื่อผู้เล่น จอ host เอาไปประกอบตึกที่ shared/tower3d.js
        label: { th: "ต่อตึก", en: "Tower Stack" },
        desc: {
            th: "ตอบถูกได้บล็อกต่อตึก ตอบไวบล็อกสูงกว่า ตอบผิดบล็อกร่วง ตึกใครสูงสุดชนะ",
            en: "Correct answers stack a block on your tower — faster means taller, wrong ones fall off. Tallest tower wins"
        },
        color: "#0f766e",
        icon: "🏗️",
        tower: true
