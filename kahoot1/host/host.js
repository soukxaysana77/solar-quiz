document.addEventListener('DOMContentLoaded', () => {
  ...
  // เก็บไว้วาดใหม่ตอนสลับภาษา ข้อความ "N ข้อ" ไม่มี data-i18n มารับ
  ...
  const handle = (msg) => {
    ...
    if (msg.type === 'HOST_READY') {
      ...
      KG.preload(msg.media, (done, total) => {
        ...
        el.answered.textContent = t('lobby.preloading', { done, total });
      });
      return;
    }
  ...
  KG.i18n.onChange(() => {
    ...
    if (totalQuestions !== null) el.count.textContent = t('host.questionCount', { n: totalQuestions });
