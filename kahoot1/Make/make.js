document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadSlideData(index) {
        ...
        // ข้อความในกล่องนี้ JS วาดเอง เลยต้องดึงคำแปลตรงนี้ ไม่ได้ผ่าน data-i18n
        mediaBox.innerHTML = slide.mediaUrl ? '' : `<div class="media-tools">🎭 🎬 🔊</div><div class="media-icon">+</div><div class="media-text">${KG.i18n.t('make.findMedia')}</div><div class="media-link"><u>${KG.i18n.t('make.uploadFile')}</u>${KG.i18n.t('make.dragHere')}</div>`;
